                    ...
                    setItemCount(0);
                        ...
                        >
                            <div className="flex items-center justify-between w-full">
                                <h1 className="text-[#f5f5f5] text-lg font-semifold">{menu.icon} {menu.name}</h1>
                    ...
                    return(
                        <div key={item.id} className="flex flex-col items-start justify-between p-4 rounded-lg h-[150px] cursor-pointer hover:bg-[#2a2a2a] bg-[#1a1a1a]">
                                ...
                                <div className="flex items-start justify-between w-full">
                                    <h1 className="text-[#f5f5f5] text-lg font-semifold">{item.name}</h1>
                                <button onClick={() => handelAddToCart(item)} className="bg-[#2e4a40] text-[#02ca3a] p-2 rounded-lg"><FaCartShopping size={20}/></button>
                                </div>
                                <div className="flex items-center justify-between w-full">
